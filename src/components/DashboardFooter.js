...
export const DashboardFooter = ({mode}) =>  {
    ...
    return (
        <Navbar bg="dark" variant="dark" sticky="bottom">
            <Navbar.Brand><span style={{display: "inline-block", ...fontStyle, marginTop: -10, textTransform: "uppercase", fontWeight: "bold"}}>&copy; 2020 magixIT LLC V1.04</span></Navbar.Brand>
